...
const templates = () => {
    return {
      ...
      'message': (data) => {
          ...
          let me = (data.nome === get_user()['nome']) ? true : false;
          // return '';
          return $(`
              <div id="${data.id}" class="message">
                ...
                <div class="body" style="${(me) ? 'border-bottom-right-radius: 0px !important;background:' + chat.colors.message_me + ';' : 'border-bottom-left-radius:0px!important;'}">
                  <div class="body-user">
